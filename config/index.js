module.exports = {
  ...
  facebook: {
    ...
    callback:
      'https://peaceful-fortress-18867.herokuapp.com/api/v1/auth/facebook/callback',
  ...
  google: {
    ...
    callback:
      'https://peaceful-fortress-18867.herokuapp.com/api/v1/auth/google/callback',
  ...
  linkedIn: {
    ...
    callback:
      'https://peaceful-fortress-18867.herokuapp.com/api/v1/auth/linkedin/callback',
